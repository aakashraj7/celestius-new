        ...
        <div className="relative z-10 lg:col-span-7 space-y-6">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-[#5865F2]/10 text-[#5865F2] font-mono text-xs font-semibold border border-[#5865F2]/40 hover:bg-[#5865F2]/20 hover:border-[#5865F2] hover:shadow-[0_0_20px_rgba(88,101,242,0.25)] active:scale-95 transition-all cursor-pointer group"
              title="Join Celestius Discord Server"
            >
              {/* Discord SVG Icon */}
              <svg 
                viewBox="0 0 24 24" 
